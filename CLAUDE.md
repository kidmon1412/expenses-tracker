...
A personal expense tracker that logs cash and online transactions, categorises spending, monitors savings targets, and generates exportable reports — with a free trial and paid tier.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "238494145+kidmon1412@users.noreply.github.com"
  git config user.name "kidmon1412"
  ```
